            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="menu.php" class="active">Home</a></li>
                            <li class="submenu">
                                <a href="javascript:;">Envoi de sms</a>
                                <ul>
                                    <li><a href="numero.php">Envoi a un numéro de telephone</a></li>
                                    <li><a href="excel.php">Envoi a une liste de contact(Excel Xlxs)</a></li>
                                    <li><a href="program-num.php">Envoi de sms programmés</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:;">Inscription/Connection</a>
                                <ul>
                                    <li><a href="auth/inscription.php">Inscription</a></li>
                                    <li><a href="auth/connexion.php">Connection</a></li>
                                </ul>
                            </li>
        ...
        <div class="Modern-Slider">
          ...
          <div class="item">
            <div class="img-fill">
                ...
                <div class="text-content">
                  ...
                  <h5>Meilleur plateforme d'envoi de sms</h5>
                  <a href="#" class="main-stroked-button">Learn More</a>
                  <a href="numero.php" class="main-filled-button">Get It Now</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
          ...
          <div class="item">
            <div class="img-fill">
                ...
                <div class="text-content">
                  <h3>Integrated Media</h3>
                  <h5>Envoi a une liste de contact(Excel Xlxs)</h5>
                  <a href="#" class="main-stroked-button">Read More</a>
                  <a href="excel.php" class="main-filled-button">Take Action</a>
                </div>
            </div>
          </div>
          <!-- // Item -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima, ipsam dolor recusandae, magni rem quam architecto harum amet reiciendis odit ut quod tempore repellendus soluta placeat sunt officia, in deleniti!
                        <br><br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio officiis cum fugiat dolorem inventore asperiores porro aut. Et minima ut amet. Expedita repudiandae reiciendis, tenetur cum molestias natus assumenda porro.
                      <br><br>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat dignissimos vel voluptatem placeat ratione corrupti praesentium </p>
                    </div>
                </div>
            </div>
        </div>
